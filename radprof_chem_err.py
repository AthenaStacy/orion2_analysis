...
for i in range(bin_num_square):
        menc_err.append(np.fabs((massenc_arr[i] - mencB[i])/mencB[i]))
        temp_err.append(np.fabs((temp_arr[i] - tempB[i])/tempB[i]))
        h2_err.append(np.fabs((h2_arr[i] - h2B[i])/h2B[i]))
	hd_err.append(np.fabs((hd_arr[i] - hdB[i])/hdB[i]))
	elec_err.append(np.fabs((elec_arr[i] - elecB[i])/elecB[i]))
#####################################################################################
...
pl.subplot(323)
pl.plot(rad_arr, h2_err,'k')
ax = pl.gca()
ax.set_xscale('log')
ax.set_yscale('log')
ax.set_xlabel('Radius [AU]', fontsize=9)
ax.set_ylabel('H_2 error', fontsize=9)
pl.xticks(fontsize=10)
pl.yticks(fontsize=10)
pl.axis((rmin, rmax, err_min, err_max))

pl.subplot(324)
pl.plot(rad_arr, hd_err,'k')
ax = pl.gca()
ax.set_xscale('log')
ax.set_yscale('log')
ax.set_xlabel('Radius [AU]', fontsize=9)
...
pl.subplot(325)
pl.plot(rad_arr, elec_err,'k')
ax = pl.gca()
ax.set_xscale('log')
ax.set_yscale('log')
ax.set_xlabel('Radius [AU]', fontsize=9)
ax.set_ylabel('e- error', fontsize=9)
pl.xticks(fontsize=10)
pl.yticks(fontsize=10)
pl.axis((rmin, rmax, err_min, err_max))
...
pl.subplot(326)
pl.plot(rad_arr, menc_err,'k')
ax = pl.gca()
ax.set_xscale('log')
ax.set_yscale('log')
ax.set_xlabel('Radius [AU]', fontsize=9)
ax.set_ylabel('Enclosed Mass error', fontsize=9)
pl.xticks(fontsize=9)
pl.yticks(fontsize=9)
pl.axis((rmin, rmax, 1.e-2*err_min, err_max))
