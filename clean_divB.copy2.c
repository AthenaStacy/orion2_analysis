...
for(igrid=0; igrid<gnum; igrid++)
 for(jgrid=0; jgrid<gnum; jgrid++)
   for(kgrid=0; kgrid<gnum; kgrid++)
     ...
     get_hilo();
     get_gphi_alt(n); 
     gphi_xplus = 1.*grid[n].DivB[igrid][jgrid][kgrid] * DeltaX - (gphi_zplus + gphi_zmin)  - (gphi_yplus + gphi_ymin) - gphi_xmin + 0.*grid[n].grad_phi[igrid][jgrid][kgrid];
...
for(igrid=0; igrid<gnum; igrid++)
 for(jgrid=0; jgrid<gnum; jgrid++)
   for(kgrid=0; kgrid<gnum; kgrid++)
     ...
     get_hilo();
     get_gphi_alt(n);
     gphi_yplus = 1.*grid[n].DivB[igrid][jgrid][kgrid] * DeltaX - (gphi_xplus + gphi_xmin)  - (gphi_zplus + gphi_zmin) - gphi_ymin +  0.*grid[n].grad_phi[igrid][jgrid][kgrid];
...
for(igrid=0; igrid<gnum; igrid++)
 for(jgrid=0; jgrid<gnum; jgrid++)
   for(kgrid=0; kgrid<gnum; kgrid++)
     ...
     get_hilo();
     get_gphi_alt(n);
     gphi_zplus = 1.*grid[n].DivB[igrid][jgrid][kgrid] * DeltaX - (gphi_xplus + gphi_xmin)  - (gphi_yplus + gphi_ymin) - gphi_zmin +  0.*grid[n].grad_phi[igrid][jgrid][kgrid];
...
/*
     get_gphi(n);
     grid[n].Bx_new[igrid][jgrid][kgrid] = grid[n].Bfieldx[igrid][jgrid][kgrid] - (gphi_xplus - gphi_xmin)/1.;
     grid[n].By_new[igrid][jgrid][kgrid] = grid[n].Bfieldy[igrid][jgrid][kgrid] - (gphi_yplus - gphi_ymin)/1.;
     grid[n].Bz_new[igrid][jgrid][kgrid] = grid[n].Bfieldz[igrid][jgrid][kgrid] - (gphi_zplus - gphi_zmin)/1.;
*/
