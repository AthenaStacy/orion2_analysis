...
{
    char path_in[200], path_in2[200], path_out[200], input_fname[200], input_fname2[200], output_fname[200], basename[200], basename2[200], basenameout[200];
  ...
  */
    ...
    for(n=0;n < Ngas; n++)
    {
       ...
       if(myrank == 0 && n % 1000 == 0) printf("pos0 = %lg, pos1 = %lg, pos2 = %lg, disx = %lg, disy = %lg, disz = %lg, CtoP = %lg, width/2.0 = %lg\n",
                                                P[n].Pos[0], P[n].Pos[1], P[n].Pos[2], disx, disy, disz, CtoP, width/2.0);
