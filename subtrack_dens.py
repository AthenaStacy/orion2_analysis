...
#Give me a file name
#pf  = load("/work/00863/minerva/orion/bfield_ref2_maptest1/" + 'data.' + datanum1 + '.3d.hdf5')

pf = load("/work/00863/minerva/orion/bfield_maptest1/" + 'data.' + datanum2 + '.3d.hdf5')
#pf2 = load("/work/00863/minerva/orion/bfield_maptest2/" + 'data.' + datanum2 + '.3d.hdf5')
pf2 = load("/work/00863/minerva/orion/bfield_maptest2/" + 'data.' + datanum2 + '.3d.hdf5')
