...
//     grid[n].Bx_new[igrid][jgrid][kgrid] = (Bx_left + By_right)/2.; 

/*
     get_gphi_alt(n);    
     gphi_xplus = gphi_xmin + 2.*(grid[n].Bfieldx[igrid][jgrid][kgrid] -  grid[n].Bx_new[igrid][jgrid][kgrid]);
...
//     grid[n].grad_phi[igrid][jgrid][kgrid] = (gphi_xmin + gphi_xplus)/2.;
...
//     grid[n].By_new[igrid][jgrid][kgrid] = (By_left + By_right)/2.;
/*
     get_gphi_alt(n);
     gphi_yplus = gphi_ymin + 2.*(grid[n].Bfieldy[igrid][jgrid][kgrid] -  grid[n].By_new[igrid][jgrid][kgrid]);
...
//     grid[n].grad_phi[igrid][jgrid][kgrid] = (gphi_ymin + gphi_yplus)/2.;
...
/*
     grid[n].Bz_new[igrid][jgrid][kgrid] = (Bz_left + Bz_left)/2.; 

     get_gphi_alt(n);
     gphi_zplus = gphi_zmin + 2.*(grid[n].Bfieldz[igrid][jgrid][kgrid] -  grid[n].Bz_new[igrid][jgrid][kgrid]);
...
//     grid[n].grad_phi[igrid][jgrid][kgrid] = (gphi_zmin + gphi_zplus)/2.;
