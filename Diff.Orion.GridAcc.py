...
#fname  = '/work/00863/minerva/orion/gravpot_10pc_256_ref3b/data.0000.3d.hdf5'
#fname2 = '/work/00863/minerva/orion/gravpot_10pc_256_ref3b/data.0000.3d.hdf5'
...
fname  = '/work/00863/minerva/orion/gravpot_0.5pc_256_ref3LD_with_edge/data.0000.3d.hdf5'
fname2 = '/work/00863/minerva/orion/gravpot_0.5pc_256_ref3LD_with_edge/data.0000.3d.hdf5'
...
fname1 = '/work/00863/minerva/orion/gadget2accX_ref3_0.5pc_256'
fname2 = '/work/00863/minerva/orion/gadget2accY_ref3_0.5pc_256'
fname3 = '/work/00863/minerva/orion/gadget2accZ_ref3_0.5pc_256'

gaccx = np.fromfile(fname1, dtype=float, count=-1)
gaccx = numpy.reshape(gaccx, [narr,narr,narr])
gaccy = np.fromfile(fname2, dtype=float, count=-1)
gaccy = numpy.reshape(gaccy, [narr,narr,narr])
gaccz = np.fromfile(fname3, dtype=float, count=-1)
gaccz = numpy.reshape(gaccz, [narr,narr,narr])

for i in range(len(gaccx)): gaccXx.append(np.sqrt(gaccx[i, cen, cen]*gaccx[i, cen, cen] + gaccy[i, cen, cen]*gaccy[i, cen, cen] + gaccz[i, cen, cen]*gaccz[i, cen, cen]) )
for i in range(len(gaccy)): gaccYy.append(np.sqrt(gaccx[cen, i, cen]*gaccx[cen, i, cen] + gaccy[cen, i, cen]*gaccy[cen, i, cen] + gaccz[cen, i, cen]*gaccz[cen, i, cen]) )
for i in range(len(gaccz)): gaccZz.append(np.sqrt(gaccx[cen, cen, i]*gaccx[cen, cen, i] + gaccy[cen, cen, i]*gaccy[cen, cen, i] + gaccz[cen, cen, i]*gaccz[cen, cen, i]) )
...
plt.plot(Saxis,accMagX,color=triad1)
plt.plot(Saxis,accMagY,color=triad2)
plt.plot(Saxis,accMagZ,color=triad3)
