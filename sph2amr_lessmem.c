...
{
    char path_in[200], path_in2[200], path_out[200], input_fname[200], input_fname2[200], output_fname[200], basename[200], basenameout[200];
...
#if (readB)
    sprintf(input_fname2, "%s_bfield_%04d.dat", path_in2, snapshot_number);
