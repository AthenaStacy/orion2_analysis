...
for i in range(bin_num_square):
	xmom_err.append((xmom_arr[i] - xmomB[i])/xmomB[i])
	ymom_err.append((ymom_arr[i] - ymomB[i])/ymomB[i])	
	zmom_err.append((zmom_arr[i] - zmomB[i])/zmomB[i])
	eint_err.append((eint_arr[i] - eintB[i])/eintB[i])
        if i == 0:
...
pl.subplot(321)
pl.plot(rad_arr, xmom_arr, 'k')
#pl.plot(radA, xmomA)
pl.plot(radB, xmomB, 'r--')
ax = pl.gca()
ax.set_xscale('log')
ax.set_xlabel('Radius [AU]', fontsize=9)
ax.set_ylabel('total x-momentum [cgs]', fontsize=9)
pl.xticks(fontsize=10)
pl.yticks(fontsize=10)
pl.axis((rmin, rmax, mmin, mmax))

pl.subplot(322)
pl.plot(rad_arr, ymom_arr,'k')
#pl.plot(radA, ymomA)
pl.plot(radB, ymomB, 'r--')
ax = pl.gca()
ax.set_xscale('log')
ax.set_xlabel('Radius [AU]', fontsize=9)
ax.set_ylabel('total y-momentum [cgs]', fontsize=9)
pl.xticks(fontsize=10)
pl.yticks(fontsize=10)
pl.axis((rmin, rmax, mmin, mmax))

pl.subplot(323)
pl.plot(rad_arr, zmom_arr,'k')
#pl.plot(radA, zmomA)
pl.plot(radB, zmomB, 'r--')
ax = pl.gca()
ax.set_xscale('log')
ax.set_xlabel('Radius [AU]', fontsize=9)
ax.set_ylabel('total z-momentum [cgs]', fontsize=9)
pl.xticks(fontsize=10)
pl.yticks(fontsize=10)
pl.axis((rmin, rmax, mmin, mmax))

pl.subplot(324)
pl.plot(rad_arr, eint_arr,'k')
#pl.plot(radA, eintA)
pl.plot(radB, eintB, 'r--')
ax = pl.gca()
ax.set_xscale('log')
ax.set_yscale('log')
ax.set_xlabel('Radius [AU]', fontsize=9)
ax.set_ylabel('total internal energy', fontsize=9)
pl.xticks(fontsize=9)
pl.yticks(fontsize=9)
pl.axis((rmin, rmax, 1.e46, 1.e48))

pl.subplot(325)
pl.plot(rad_arr, gpot_arr,'k')
pl.plot(radB, gpotB, 'r--')
ax = pl.gca()
#ax.set_xscale('log')
ax.set_yscale('log')
ax.set_xlabel('Radius [AU]', fontsize=9)
ax.set_ylabel('total gravitational potential', fontsize=9)
pl.xticks(fontsize=9)
pl.yticks(fontsize=9)
pl.axis((rmin, rmax, 1.e10, 1.e13))

pl.subplot(326)
pl.plot(rad_arr, gacc_arr,'k')
pl.plot(radB, gaccB, 'r--')
ax = pl.gca()
#ax.set_xscale('log')
ax.set_yscale('log')
ax.set_xlabel('Radius [AU]', fontsize=9)
ax.set_ylabel('gravitational acceleration', fontsize=9)
pl.xticks(fontsize=9)
pl.yticks(fontsize=9)
