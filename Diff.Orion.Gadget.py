...
#fname  = '/work/00863/minerva/orion/gravpot_1.6pc_256/data.0000.3d.hdf5'
#fname2 = '/work/00863/minerva/orion/gravpot_1.6pc_256/data.0000.3d.hdf5'
#cen = 127
#cen2 = 127

#fname  = '/work/00863/minerva/orion/gravpot_1.6pc_128/data.0000.3d.hdf5'
#fname2 = '/work/00863/minerva/orion/gravpot_1.6pc_128/data.0000.3d.hdf5'
#cen = 63
#cen2 = 63
...
print 'length2 =', len(accMagX2)

ax4=plt.subplot(224)

accErrorX = []
for i in range(len(accMagX)): accErrorX.append( 2.0*np.fabs(accMagX2[i+grid_shift]-accMagX[i])/( accMagX2[i+grid_shift]+accMagX[i]) )
accErrorY = []
for i in range(len(accMagY)): accErrorY.append( 2.0*np.fabs(accMagY2[i+grid_shift]-accMagY[i])/( accMagY2[i+grid_shift]+accMagY[i]) )
accErrorZ = []
for i in range(len(accMagZ)): accErrorZ.append( 2.0*np.fabs(accMagZ2[i+grid_shift]-accMagZ[i])/( accMagZ2[i+grid_shift]+accMagZ[i]) )
