...
#define pathname_in "/work/00863/minerva/sod"

#define pathname_out "/work/00863/minerva/orion"

#define ref_lev 128 //number of grid cells along each x-y-z direction
#define width  1e3 //size of box in pc to be "cut out" of Gadget2 simulation box and mapped onto the Orion2 grid 
...
int main(int argc, char **argv)
{
  ...
  int  j, n, type, snapshot_number, files, Ngas, Ngas2, random, num_err_HI;
  ...
  sprintf(output_fname, "%s/gadget2orion_sod_%04d", path_out, snapshot_number);
