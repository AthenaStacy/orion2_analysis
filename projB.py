...
dmin = 1.e-1
dmax = 5.e-1
prj = ProjectionPlot(pf, 'z', 'density', weight_field = "Density", width=(1.0,'pc'))
...
prj = ProjectionPlot(pf, 'z', 'Bmag-log', weight_field = "Bmag-log", width=(1.0,'pc'))
#prj.set_zlim('Bmag-log', bmin, bmax)
prj.set_cmap("Bmag-log", "Rainbow18")
prj.save('data.'+ datanum)

prj = ProjectionPlot(pf, 'z', 'Bx-log', weight_field = "Bx-log", width=(1.0,'pc'))
#prj.set_zlim('Bx-log', bmin, bmax)
prj.set_cmap("Bx-log", "Rainbow18")
prj.save('data.'+ datanum)

prj = ProjectionPlot(pf, 'z', 'By-log', weight_field = "By-log", width=(1.0,'pc'))
#prj.set_zlim('By-log', bmin, bmax)
prj.set_cmap("By-log", "Rainbow18")
prj.save('data.'+ datanum)

prj = ProjectionPlot(pf, 'z', 'Bz-log', weight_field = "Bz-log", width=(1.0,'pc'))
