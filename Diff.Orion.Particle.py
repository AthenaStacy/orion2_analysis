...
#fname2 = '/work/00863/minerva/orion/gravpot_0.4pc_064/data.0000.3d.hdf5'
#cen = 31
#cen2 = 31

#fname  = '/work/00863/minerva/orion/gravpot_1pc_128_ref3/data.0000.3d.hdf5'
#fname2 = '/work/00863/minerva/orion/gravpot_1pc_128_ref3/data.0000.3d.hdf5'

#fname  = '/work/00863/minerva/orion/gravpot_1pc_256_ref3b/data.0000.3d.hdf5'
#fname2 = '/work/00863/minerva/orion/gravpot_1pc_256_ref3b/data.0000.3d.hdf5'

#fname  = '/work/00863/minerva/orion/gravpot_0.5pc_256_HR10/data.0000.3d.hdf5'
#fname2 = '/work/00863/minerva/orion/gravpot_0.5pc_256_HR10/data.0000.3d.hdf5'

#fname  = '/work/00863/minerva/orion/data.0000.3d.hdf5'
#fname2 = '/work/00863/minerva/orion/data.0000.3d.hdf5'

#fname  = '/work/00863/minerva/orion_Gtest/data.0000.3d.hdf5'
#fname2 = '/work/00863/minerva/orion_Gtest/data.0000.3d.hdf5'

#fname  = '/work/00863/minerva/orion/gravpot_0.5pc_256_ref3LD/data.0000.3d.hdf5'
#fname2 = '/work/00863/minerva/orion/gravpot_0.5pc_256_ref3LD/data.0000.3d.hdf5'

fname  = '/work/00863/minerva/orion_Gtest/Orion2512init.3d.hdf5'
fname2 = '/work/00863/minerva/orion_Gtest/Orion2512init.3d.hdf5'
...
for i in range(1,len(axis2)-gshift,1): accX2x.append( CenDiff(g2,i,cen2,cen2,1)/DeltaX )
for i in range(1,len(axis)-gshift,1): accYx.append( CenDiff(g,i,cen,cen,2)/DeltaX )
for i in range(1,len(axis2)-gshift,1): accY2x.append( CenDiff(g2,i,cen2,cen2,2)/DeltaX )
for i in range(1,len(axis)-gshift,1): accZx.append( CenDiff(g,i,cen,cen,3)/DeltaX )
for i in range(1,len(axis2)-gshift,1): accZ2x.append( CenDiff(g2,i,cen2,cen2,3)/DeltaX )

for i in range(1,len(axis)-gshift,1): accXy.append( CenDiff(g,cen,i,cen,1)/DeltaX )
for i in range(1,len(axis2)-gshift,1): accX2y.append( CenDiff(g2,cen2,i,cen2,1)/DeltaX )
for i in range(1,len(axis)-gshift,1): accYy.append( CenDiff(g,cen,i,cen,2)/DeltaX )
for i in range(1,len(axis2)-gshift,1): accY2y.append( CenDiff(g2,cen2,i,cen2,2)/DeltaX )
for i in range(1,len(axis)-gshift,1): accZy.append( CenDiff(g,cen,i,cen,3)/DeltaX )
for i in range(1,len(axis2)-gshift,1): accZ2y.append( CenDiff(g2,cen2,i,cen2,3)/DeltaX )

for i in range(1,len(axis)-gshift,1): accXz.append( CenDiff(g,cen,cen,i,1)/DeltaX )
for i in range(1,len(axis2)-gshift,1): accX2z.append( CenDiff(g2,cen2,cen2,i,1)/DeltaX )
for i in range(1,len(axis)-gshift,1): accYz.append( CenDiff(g,cen,cen,i,2)/DeltaX )
for i in range(1,len(axis2)-gshift,1): accY2z.append( CenDiff(g2,cen2,cen2,i,2)/DeltaX )
for i in range(1,len(axis)-gshift,1): accZz.append( CenDiff(g,cen,cen,i,3)/DeltaX )
for i in range(1,len(axis2)-gshift,1): accZ2z.append( CenDiff(g2,cen2,cen2,i,3)/DeltaX )
...
Saxis = axis[1:dims[1]-gshift]
Saxis2 = axis2[1:dims2[1]-gshift]
...
length = len(Saxis)
for i in range(length/2 - 0, length/2 + 0):
	accXx[i] = 0 
	accYy[i] = 0
	accZz[i] = 0
...
for i in range(len(axis2)): 
	densx_arr.append(d2[i, cen2, cen2]) 
	densy_arr.append(d2[cen2, i, cen2])
	densz_arr.append(d2[cen2, cen2, i])

plt.semilogy(axis2,densx_arr,color=triad1)
plt.semilogy(axis2,densy_arr,color=triad2)
plt.semilogy(axis2,densz_arr,color=triad3)
